<div class="half" style="vertical-align:top;">
    ...
    <div class="rb tab" style="width:95%;">
        <div style="height:300px">
            <div id="change" style="position:relative">
                <img id="showpost" style="height:250px;width:200px;"></img>
                <div id="showlist"></div>
            </div>
        </div>
        <div style="height:100px;display:flex;">
            ...
            ?>
                <div class="im" id="ssaa<?= $key; ?>"><img onclick="change(<?= $key; ?>)" src="img/<?= $p['img']; ?>" style="width:80px;height:80px;"><br><span><?= $p['name']; ?></span>
                </div>
            <?php
            }
            ?>
...
<div>
    ...
    <div>上映日期<br><?=$m['date'];?></div>
        ...
        <div><a href="?do=intro&id=<?=$m['id'];?>"><button>劇情簡介</button></a>
        <a href="?do=order&id=<?=$m['id'];?>"><button>線上訂票</button></a>
    </div>
    </div>
